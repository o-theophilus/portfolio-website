...
<Content fit>
	<Observe let:intersecting>
		<div class="observe" class:intersecting>
			...
			My name is <strong>Theophilus</strong>, and I am a multidisciplinary self-taught designer and
			programmer with a passion for learning and creating impactful designs for web and print. I am
			always seeking new challenges and opportunities to expand my skills and knowledge.

			<br /><br />

			I spend most of my time working on personal projects, contributing to open-source projects,
			and sharing my knowledge with others. I believe in the power of community and collaboration
			and have benefited greatly from the support and mentorship of others.
...
<style>
	...
	svg {
		...
		/* animation: moveRight 30s cubic-bezier(0.42, 0, 0.58, 1) infinite reverse; */
	}
	...
	.one {
		...
		animation: moveRight 30s cubic-bezier(0.42, 0, 0.58, 1) infinite;
	}
